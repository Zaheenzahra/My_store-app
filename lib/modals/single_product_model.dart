class SingleProductModel {
  ...
  SingleProductModel({this.products, this.total, this.skip, this.limit});
...
class Products {
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    // Ensure 'price' is a double, even if it's an integer
    price = (json['price'] is int)
        ? (json['price'] as int).toDouble()
        : json['price'];
    // Ensure 'discountPercentage' is a double, even if it's an integer
    discountPercentage = (json['discountPercentage'] is int)
        ? (json['discountPercentage'] as int).toDouble()
        : json['discountPercentage'];
    // Ensure 'rating' is a double, even if it's an integer
